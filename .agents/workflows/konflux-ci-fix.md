...
# Example: grep -A 2 "Name: subctl-0-22\$" /tmp/ec-report.txt
...
Expected: The subctl component shows 0 violations.

**Note:** subctl is the only component in this repo, so no multi-component considerations apply.
