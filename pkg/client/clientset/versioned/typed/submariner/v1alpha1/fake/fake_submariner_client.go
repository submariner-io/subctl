...
import (
	v1alpha1 "github.com/submariner-io/subctl/pkg/client/clientset/versioned/typed/submariner/v1alpha1"
...
func (c *FakeSubmarinerV1alpha1) Brokers(namespace string) v1alpha1.BrokerInterface {
