...
func gatherServiceExports(info *Info, namespace string) {
	ResourcesToYAMLFile(info, gvr.ResourceFromMetaGroupVersion(mcsv1a1.GroupVersion, "serviceexports"), namespace, metav1.ListOptions{})
}

func gatherServiceImports(info *Info, namespace string) {
	ResourcesToYAMLFile(info, gvr.ResourceFromMetaGroupVersion(mcsv1a1.GroupVersion, "serviceimports"), namespace, metav1.ListOptions{})
}
