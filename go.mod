...
require (
	...
	github.com/openshift/api v0.0.0-20200324173355-9b3bdf846ea1 // indirect
	github.com/openshift/cluster-dns-operator v0.0.0-20200529200012-f9e4dfc90c57 // indirect
