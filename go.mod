...
require (
	...
	github.com/submariner-io/cloud-prepare v0.14.4
	github.com/submariner-io/lighthouse v0.14.4
	github.com/submariner-io/shipyard v0.14.5
	github.com/submariner-io/submariner v0.14.4
	github.com/submariner-io/submariner-operator v0.14.4
